...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/KfFDIhY2vlPurGeUzMLP7M5WzAu2/social-images/social-1782310837858-Gemini_Generated_Image_35nhc035nhc035nh.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/KfFDIhY2vlPurGeUzMLP7M5WzAu2/social-images/social-1782310837858-Gemini_Generated_Image_35nhc035nhc035nh.webp" },
      { title: "Lovable App" },
      { property: "og:title", content: "Lovable App" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "description", content: "ordering guide" },
      { property: "og:description", content: "ordering guide" },
      { name: "twitter:description", content: "ordering guide" },
    ],
    links: [
